...
for (var instance in SELECTORS) {
  ...
  if (ins[instance].length) {
    ...
    try {
      for (var _iterator = ins[instance][Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        var component = _step.value;

        if (component.length) {
          var slickInstance = new _componentsGnCarousel.GnCarousel((0, _jquery2['default'])(component), OPTIONS);
